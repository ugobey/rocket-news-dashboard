...
const testAlertData = [
    ...
    {
        type: "missiles",
        cities: ["שייח' דנון", "שחר", "שוש", "דוב״ב"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
    ...
    {
        type: "missiles",
        cities: ["גאולים", "בת שלמה", "בת הדר", "בקוע", "כליל", "כוכב יעקב", "כוכבשחר", "כפ סירקין", "כפר קאסם", "כפר קרע", "כפר סבא", "לוד", "מזכרת בתיה", "מודיעין עילית", "נורדיה", "סביון", "סגולה", "מולדת", "פדואל", "קריית ענבים", "קריית מלאכי", "רעננה", "רמת השרון", "רמת גן - מזרח", "רמת גן - מערב", "רמלה", "שוהם"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
    ...
    {
        type: "missiles",
        cities: ["בן שמן", "בית עריף", "בי ניר", "בית חנניה", "נווה אטי''ב"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
