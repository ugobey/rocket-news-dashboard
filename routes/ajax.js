...
const testAlertData = [
    ...
    {
        type: "missiles",
        cities: ["גאולים", "בת שלמה", "בת הדר", "בקוע", "כליל", "כוכב יעקב", "כוכב השחר", "כפר סירקין", "כפר קאסם", "כפר קרע", "כפר סבא", "לוד", "מזכרת בתיה", "מודיעין עילית", "נורדיה", "סביון", "סגולה", "מולדת", "פדואל", "קריית ענבים", "קריית מלאכי", "רעננה", "רמת השרון", "רמת גן - מזרח", "רמת גן - מערב", "רמלה", "שוהם"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
    ...
    {
        type: "missiles",
        cities: ["בן שמן", "בית עריף", "בית ניר", "בית חנניה", "נווה אטי''ב"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
    ...
    {
        type: "newsFlash",
        cities: ["בענה", "דיר אל-אסד", "הר חלוץ", "לבון", "נחף", "כסרא סמיע", "מכמנים - כמאנה מערבית", "חוסנייה", "יבנה"],
        instructions: "",
        id: "134182459160000000",
    },
    {
        type: "newsFlash",
        cities: ["גאולים", "בת שלמה", "בת הדר", "בקוע", "כליל", "כוכב יעקב", "כוכב השחר"],
        instructions: "",
        id: "134182459160000000",
    },
    {
