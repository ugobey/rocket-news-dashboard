...
const testAlertData = [
    {
        type: "missiles",
        cities: ["בענה", "דיר אל-אסד", "הר חלוץ", "לבן", "נחף", "כסרא סמיע", "מכמנים - כמאנה מערבית", "חוסנייה"],
    ...
    {
        type: "missiles",
        cities: ["גאולים", "בת שלמה", "בת הדר", "בקוע", "כליל", "כוכב יעב", "כוכב השחר", "כפר סירקין", "כפר קאסם", "כפר קרע", "כפר סבא", "לוד", "מזכרת ביה", "מודיעין עילית", "נורדיה", "סביון", "סגולה",  "מולדת", "פדואל", "קריית ענבים", "קריית מלאכי", "רעננה", "רמת השרון", "רמת גן - מזרח", "רמת גן - מערב", "רמלה", "שוהם"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
    ...
    {
        type: "hostileAircraftIntrusion",
        cities: ["בית השיטה", "ביר אלמכסור", "באר שבע - צפן", "כפר אחים", "כסלון"],
        instructions: "ירי רקטות וטילים",
        id: "134182459160000000",
    },
    {
